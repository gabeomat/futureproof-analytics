...
export function DualMRRView() {
  return (
    <div className="rounded-lg border border-border bg-card p-6">
      ...
      <p className="text-xs text-muted-foreground mb-5">Skool's definition vs G's pure monthly MRR</p>
      
      <div className="grid grid-cols-2 gap-6">
        {/* Skool's MRR */}
        <div className="rounded-lg border border-border bg-secondary/30 p-5">
          <p className="text-xs font-medium uppercase tracking-wider text-muted-foreground mb-3">Skool MRR</p>
          <p className="font-display text-3xl font-bold text-foreground">{formatCurrency(currentSnapshot.skoolMRR)}</p>
          <p className="text-xs text-muted-foreground mt-2">Includes annualized annual revenue</p>
        ...
        <div className="rounded-lg border border-primary/30 bg-primary/5 p-5 shadow-glow">
          <p className="text-xs font-medium uppercase tracking-wider text-primary mb-3">Pure Monthly MRR</p>
          <p className="font-display text-3xl font-bold text-primary">{formatCurrency(currentSnapshot.pureMonthlyMRR)}</p>
          <p className="text-xs text-muted-foreground mt-2">Monthly subscriptions only</p>
          <div className="mt-4 space-y-2">
            <div className="flex justify-between text-xs">
